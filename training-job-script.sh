...
python ~/SFU_research_internship/examples/images/cifar10/ImageBaselineExperiment/Cifar10_train_sfu.py --num_channels=32
  --batch_size=10 --tiny_dataset_size=50 --epochs=2 --Save_step=1 --Dataset_download_flag=True
echo "Done"
