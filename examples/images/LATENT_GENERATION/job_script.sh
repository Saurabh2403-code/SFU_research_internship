#!/bin/bash
#SBATCH --job-name=training-icfm-for-ffhq-full-dataset
...
echo "Launching ICFM 100K Training Job for FFHQ dataset 100 Images "
...
python /home/saurabhg/SFU_research_internship/examples/images/LATENT_GENERATION/vae_train2.py \
    --model=icfm \
    --dataset_address='/home/saurabhg/scratch/FLOW_BASED_MODELS/LATENT_DATASET/img' \
